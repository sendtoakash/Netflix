        ...
        <div>
            <div className="bg-black py-6 px-4">
                ...
                <div className="flex items-center gap-3 mb-5 px-2">
                    ...
                    <h1 className="text-white font-bold text-xl tracking-wide uppercase">Now Playing</h1>
                    ...
                    {nowPlaying.map((nowplay) => (
                        ...
                        >
                            ...
                            <div className="relative overflow-hidden rounded-lg">
                                <img
                                    src={'https://image.tmdb.org/t/p/w500' + nowplay.poster_path}
                                    alt={nowplay.original_title}
