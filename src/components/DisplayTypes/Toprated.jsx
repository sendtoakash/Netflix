...
function TopRated() {
    useTopRated()
    const topratedVideo = useSelector((state) => state.movie.toprated);
    console.log(topratedVideo, "toprated")

    if (!topratedVideo || topratedVideo.length == 0) return;
    return (
        <div>
            <div className="bg-black py-6 px-4">
                ...
                <div className="flex items-center gap-3 mb-5 px-2">
                    ...
                    <h1 className="text-white font-bold text-xl tracking-wide uppercase">Top Rated Movie</h1>
                ...
                >
                    {topratedVideo.map((topratedMovie) => (
                        <div
